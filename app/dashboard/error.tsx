...
export default function DashboardError({
  ...
  return (
    <div className="max-w-md mx-auto py-20 text-center">
      ...
      {error.digest && (
        <p className="text-slate-600 text-xs mb-4 font-mono">Error: {error.digest}</p>
      )}
      <div className="flex items-center justify-center gap-3">
        ...
        <Link href="/dashboard"
          className="px-5 py-2.5 rounded-xl text-sm font-medium text-slate-400 border border-slate-700/50 hover:text-white transition-colors">
          Dashboard
        </Link>
      </div>
    </div>
