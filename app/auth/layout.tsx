...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--color-abyss)] relative py-4 sm:py-6">
      {/* Background pattern */}
      <div
      ...
      <div className="relative z-10 w-full max-w-md px-4 py-4 sm:py-6">
        {children}
      </div>
    </div>
  )
